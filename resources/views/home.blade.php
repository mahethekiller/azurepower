<x-common-layout :pageTitle="$pageTitle" :pageDescription="$pageDescription" :pageScript="$pageScript">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-image">
                        ...
                        <div class="experience bounce-y">
                            <img src="{{ asset('assets/img/satisfied-client-icon.png') }}" alt=""
                                class="icon">
    ...
    <div class="project-layout3">
        ...
        <div class="container-fluid" style="position: relative;">
            ...
            <div class="container text-center mt-5"><a href="#"
                    class="btn-default align-items-center text-center">View
            ...
            <div class="row align-items-center section-title-row">
                <div class="col-lg-12">
                    ...
                    <div class="section-title text-center">
                        ...
                        <h2 class="text-anime">We deliver clean, reliable, and affordable renewable energy to
                            communities worldwide <br>preserving our planet for future generations.</h2>
                    </div>
                    <!-- Section Title End -->
 ...
 -->
    ...
    <div class="latest-news">
        <div class="container">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="post-item-body">
                            <div class="post-meta">
                                <ul>
                                    <li><a href="#"><i class="fa-regular fa-calendar-days"></i> 09 July 2025</a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="post-item-body">
                            <div class="post-meta">
                                <ul>
                                    <li><a href="#"><i class="fa-regular fa-calendar-days"></i> 08 July 2025</a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="blog-item wow fadeInUp" data-wow-delay="0.75s">
                        ...
                        <div class="post-item-body">
                            <div class="post-meta">
                                <ul>
                                    <li><a href="#"><i class="fa-regular fa-calendar-days"></i> 07 July 2025</a>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="container text-center mt-5"><a href="http://azurepower.ocpwebserver.com/newsroom"
                    class="btn-default align-items-center text-center">Explore</a></div>
        </div>
    </div>
                    ...
                    <div class="wow fadeInUp">
                        <div class="row">
                            <div class="col-lg-8 pr-100">
                                ...
                                <p>We harness cutting-edge technology and forward-thinking strategies to deliver
                                    impactful, long-term energy solutions.</p>
                                <!-- Section Title End -->
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-item">
                                            <div class="form-icon">
                                                <img
                                                    src="{{ asset('assets/img/Environmental-Responsibility-icon.png') }}" />
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-item">
                                            <div class="form-icon">
                                                <img
                                                    src="{{ asset('assets/img/Custom-Energy-Solutions-icon.png') }}" />
                                            </div>
                                            <div class="form-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12 mb-3">
                                                <input type="text" name="subject" class="form-control"
                                                    id="subject" placeholder="Subject Of Message*" required>
                                                <div class="help-block with-errors"></div>
                                            </div>
